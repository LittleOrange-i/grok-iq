  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed top-[var(--app-header-height,0px)] bottom-0 z-10 hidden h-[calc(100svh-var(--app-header-height,0px))] w-(--sidebar-width) transition-[inset-inline,width] duration-200 ease-linear md:flex',
          side === 'left'
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-3xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-2',
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-full px-3 py-2 text-start text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sky-50 hover:text-sky-950 focus-visible:ring-2 active:bg-sky-100 active:text-sky-950 disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pe-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sky-100 data-[active=true]:font-medium data-[active=true]:text-sky-950 data-[active=true]:hover:bg-sky-100 data-[state=open]:hover:bg-sky-50 data-[state=open]:hover:text-sky-950 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! dark:hover:bg-sky-500/10 dark:hover:text-sky-100 dark:active:bg-sky-500/20 dark:data-[active=true]:bg-sky-500/20 dark:data-[active=true]:text-sky-50 dark:data-[active=true]:hover:bg-sky-500/20 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'hover:bg-sky-50 hover:text-sky-950 dark:hover:bg-sky-500/10 dark:hover:text-sky-100',
        outline:
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        'flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-full px-2 text-sidebar-foreground ring-sidebar-ring outline-hidden hover:bg-sky-50 hover:text-sky-950 focus-visible:ring-2 active:bg-sky-100 active:text-sky-950 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 dark:hover:bg-sky-500/10 dark:hover:text-sky-100 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-inherit',
        'data-[active=true]:bg-sky-100 data-[active=true]:text-sky-950 dark:data-[active=true]:bg-sky-500/20 dark:data-[active=true]:text-sky-50',
        size === 'sm' && 'text-xs',
        size === 'md' && 'text-sm',
        'group-data-[collapsible=icon]:hidden',
        className
